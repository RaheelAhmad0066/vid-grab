...
export const FAQ = () => {
  ...
  const faqs = [
    {
      question: "What is Vidoon?",
      answer: "Vidoon is a free online tool that allows you to download videos from various popular platforms like YouTube, Facebook, Instagram, TikTok, Twitter, Vimeo, Reddit, and more. It's designed for personal, non-commercial use."
    },
    {
      question: "Is Vidoon free to use?",
      answer: "Yes, Vidoon is completely free to use. No registration or payment required. Simply paste the video URL and download."
    },
    {
      question: "What video quality options are available?",
      answer: "Vidoon offers multiple quality options depending on the source video. You can typically choose from 360p, 480p, 720p, 1080p, and higher resolutions when available. We also offer an audio-only option for MP3 downloads."
    },
    {
      question: "Is it legal to download videos?",
      answer: "Downloading videos for personal, non-commercial use is generally acceptable in many jurisdictions. However, laws vary by country. We recommend checking your local laws and the terms of service of the content platform. Vidoon is intended for personal use only."
    },
    {
      question: "Do I need to create an account?",
      answer: "No, you don't need to create an account. Vidoon is designed to be simple and accessible without registration. Just paste the URL and download."
    },
    {
      question: "What platforms does Vidoon support?",
      answer: "Vidoon supports YouTube, Facebook, Instagram, TikTok, Twitter/X, Vimeo, Reddit, Dailymotion, Twitch, and Pinterest. We're constantly adding support for more platforms."
    },
    {
    ...
    },
    {
      ...
      answer: "It's simple: 1) Copy the video URL from the platform, 2) Paste it into Vidoon's input field, 3) Click 'Analyze Video', 4) Select your preferred quality, 5) Click 'Download Now'."
    },
    {
      question: "Can I download videos on mobile devices?",
      answer: "Yes, Vidoon works on all devices including smartphones and tablets. Our website is fully responsive and optimized for mobile browsers."
    },
    {
    ...
    {
      question: "Is Vidoon safe to use?",
      answer: "Yes, Vidoon is safe to use. We don't require any personal information, and we don't host any files on our servers. All downloads are processed securely. We also don't install any software on your device."
    },
    {
    ...
    {
      question: "Does Vidoon work with private or restricted videos?",
      answer: "No, Vidoon only works with publicly accessible videos. Private, restricted, or age-restricted content cannot be downloaded."
    },
    {
    ...
    {
      question: "Does Vidoon collect my data?",
    ...
    >
      <div className="legal-container faq-container">
        ...
        <p className="faq-intro">
          Find answers to common questions about Vidoon. Can't find what you're looking for? 
